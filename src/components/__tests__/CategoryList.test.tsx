...
describe("CategoryList", () => {
  ...
  it("calls onSelectCategory when clicking a category", () => {
    ...
    render(
      <CategoryList {...defaultProps} onSelectCategory={onSelectCategory} />,
    );
  ...
  it("uses fallback icon for unknown categories", () => {
    ...
    const unknownButton = screen
      .getByText("unknown", { exact: false })
      .closest("button");
